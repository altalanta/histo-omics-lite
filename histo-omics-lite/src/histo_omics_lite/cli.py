...
def data(
    ...
    num_samples: Annotated[int, typer.Option("--num-samples", help="Number of synthetic samples")] = 1000,
    ...
    if make:
        ...
        try:
            ...
            if not json_output:
                console.print(f"[blue]Generating {num_samples} synthetic samples...[/blue]")
            ...
            if json_output:
                ...
                console.print(f"[dim]Samples created: {num_samples}[/dim]")
